...
class QuestionGenerator:
    ...
    def generate_questions_batch(
        ...
        """Generate questions for multiple prompts with BATCHED inference."""
        results = []

        for batch_start in tqdm(range(0, len(prompts), self.batch_size), desc="Generating questions"):
            ...
            for i, (prompt, template_idx) in enumerate(zip(batch_prompts, batch_template_idxs)):
                # Get generated tokens only (after the input)
